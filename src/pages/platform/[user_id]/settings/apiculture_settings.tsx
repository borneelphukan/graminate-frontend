...
const ApicultureSettings = () => {
  ...
  return (
    <>
      <Head>
        <title>{t("apicultureSettings" as TranslationKey)}</title>
      </Head>
      <PlatformLayout>
          ...
          <main className="flex-1 px-4 sm:px-6 md:px-12">
            <div className="py-6">
              <div className="pb-4 font-bold text-lg text-dark dark:text-light">
                {t("apicultureSettings" as TranslationKey)}
              </div>
              <section className="py-6">
                <div className="rounded-lg p-4">
                  <p className="dark:text-light">
                    Apiculture specific settings UI will go here.
                  </p>
                </div>
              </section>
            </div>
...
export default ApicultureSettings;
